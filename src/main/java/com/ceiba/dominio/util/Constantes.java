...
public final class Constantes {
	...
	public static final String ID_SIN_VALOR = "ID_SIN_VALOR";

	public static final String SIN_FECHA_DE_ENTRADA = "Sin fecha de entrada";

	public static final String VEHICULO_NULO = "Vehiculo Nulo";

	public static final String SIN_FECHA_DE_SALIDA = "Sin fecha de salida";

	public static final String VALOR_CERO = "Valor cero";

	public static final String NO_SE_PUEDE_HACER_LA_ENTRADA = "No se puede hacer la Entrada";
